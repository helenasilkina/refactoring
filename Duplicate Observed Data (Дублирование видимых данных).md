...
1. Этот рефакторинг, который в классическом исполнении производится с введением шаблона <a href="https://github.com/helenasilkina/patterns/blob/master/Observer%20(Наблюдатель).md">Наблюдатель</a>, малоприменим для веб-приложений, где все классы пересоздаются между запросами к веб-серверу.
